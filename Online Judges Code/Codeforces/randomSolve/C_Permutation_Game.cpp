...
void printRes(int n)
{
    for(int i=1;i<=n;i++)
    {
        ...
        else cout<<"kicchu chai ni ami!! ajibon........\n";
    }
}
...
void dfs(int cur)
{
    ...
    for(int child:g[cur])
    {
         ...
         if(res[child]==2)possible++;
    }
    if(possible>0)res[cur]=1;
    else res[cur]=2;
