...
void solve()
{
   ...
   if(vec.size()==0)
   {
    ...
    if(vec.size()==2)
    {
        int len1=vec[0].second-vec[0].first+1;
        int len2=vec[1].second-vec[1].first+1;
        if(vec[1].first-2==vec[0].second)
        {
              cout<<len1+len2<<endl;
        }
        else{
            cout<<max(len1,len2)+1<<endl;
        }
    ...
    for(int i=0;i<vec.size()-1;i++)
    {
        ...
        int len2=vec[i+1].second-vec[i+1].first+1;
         ...
         if(vec[i].second+2 == vec[i+1].first)
         {
