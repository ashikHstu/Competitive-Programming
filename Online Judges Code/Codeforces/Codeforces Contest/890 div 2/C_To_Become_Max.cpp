...
void solve()
{
    ...
    for (int id = n - 1; id >= 1; id--)
    {
        ...
        {
            ll nicchi = (ar[i + 1] + 1 - ar[i]);
            // cout << "ar[1], ar[0]  : " << ar[i + 1] << " , " << ar[i] << endl;
            // cout << "nicchi : " << nicchi << endl;
            nicchi = max(nicchi, 0LL);
            if (nicchi + komacchi <= k)
            {
